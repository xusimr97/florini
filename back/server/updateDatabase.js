...
// vnCon.connect(function (errVn) {
//   console.log('================ Connecting Database LOCAL ================\n')
//   dbCon.connect(function (errDb) {
//     if (errVn) throw errVn
//     if (errDb) throw errDb

//     console.log(
//       '================ Obtaining items data from VN ================\n'
//     )
//     // Get data form VN DATABASE
//     vnCon.query('SELECT * FROM item WHERE typeFk=232 LIMIT 200', function (
//       errQuerySelect,
//       result,
//       fields
//     ) {
//       if (errQuerySelect) throw errQuerySelect

//       console.log(result.length)
//       console.log(
//         '================ Updating items data to LOCAL ================\n'
//       )
//       result.forEach(item => {
...
//           value10: item.value10
//         }
//         var query = dbCon.query(
//           'INSERT IGNORE INTO item SET ?',
//           itemQuery,
//           function (err, result) {
//             // Neat!
